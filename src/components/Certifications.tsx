...
type Category = "all" | "ml" | "data" | "soft-skills" | "language";
...
export const Certifications = () => {
  ...
  const certifications: Certification[] = [
    ...
    },
    {
      ...
      embedUrl: "https://drive.google.com/thumbnail?id=1EqDnMZV-IQoJx8USInegDpQd94jB6lCH&sz=w2000",
      category: ["ml", "data"],
    },
    {
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredCertifications.map((cert) => (
            <Card key={cert.title} className="p-6 bg-card-gradient border-primary/20 hover:border-primary/40 transition-all duration-300 hover:shadow-glow-primary flex flex-col">
              {/* Certificate Preview */}
              ...
              <div className="mb-4">
                <div className="flex flex-wrap gap-1">
                  {cert.skills.map((skill, skillIndex) => (
                    <span key={skillIndex} className="px-2 py-0.5 bg-primary/20 text-primary text-xs rounded-full font-medium">
                      {skill}
                    </span>
                  ))}
                </div>
