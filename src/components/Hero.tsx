...
export const Hero = () => {
  return <section className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 py-20 text-[#977359]">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          {/* Content */}
          <div className="space-y-8 animate-slide-up">
            <div className="inline-block">
              <span className="px-4 py-2 rounded-full font-medium border border-primary/30 text-[#977359] text-lg bg-primary-foreground">
                Data Scientist
              </span>
            </div>
            
            <div className="space-y-6">
              <h1 className="text-5xl lg:text-7xl font-bold bg-gradient-text bg-clip-text leading-tight text-[#977359]">
                Doha Abdelrahman
              </h1>
            ...
            <div className="flex flex-wrap gap-4">
              <Button className="bg-gradient-primary hover:shadow-glow-primary transition-all duration-300 border-[#977359] text-[#977359] bg-[#977359]">
                <Mail className="w-5 h-5 mr-2" />
                Get In Touch
              </Button>
              <Button variant="outline" className="hover:bg-primary/10 border-[#977359]" onClick={() => {
        ...
        <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 animate-bounce">
          <div className="w-6 h-10 border-2 rounded-full flex justify-center border-[#977359]">
